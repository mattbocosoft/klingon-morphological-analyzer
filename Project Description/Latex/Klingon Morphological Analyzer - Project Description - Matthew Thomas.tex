...
The Klingon number system is base ten and numbers are combined just like in English with higher-order number coming first. For example 10,503 would be ten THOUSAND five HUNDRED and three. The thousands value needs to proceed the hundreds value. In order to enforce this ordering, I needed applied the same gating system that was used for the verb ordered suffix types.
